...
extern "C" void S9xMixSamples (signed short *buffer, int sample_count);
extern "C" void S9xMixSamplesO(signed short *buffer, int sample_count, int sample_offset);
